    ...
    return (
        <div className="relative grid grid-cols-2 gap-y-10 md:gap-0 md:grid-cols-4">
            ...
            <div className="flex flex-col justify-center items-center gap-2">
                <div className="relative p-6 backdrop-blur-md bg-white/10 border border-white/20 shadow-lg hover:bg-white/20 hover:text-blue-400 transition-all duration-300 hover:scale-105"
                ...
                >
                    ...
                    <div className="absolute inset-0 bg-gradient-to-br from-blue-400/20 to-transparent pointer-events-none border-2 border-blue-500"></div>
                </div>
            ...
            {/* Back-end */}
            <div className="flex flex-col justify-center items-center gap-2">
                <div className="relative p-6 backdrop-blur-md bg-white/10 border border-white/20 shadow-lg hover:bg-white/20 hover:text-green-400 transition-all duration-300 hover:scale-105"
                    onMouseEnter={() => setLineColor("bg-green-400")}
                    onMouseLeave={() => setLineColor("bg-white/20")}
                >
                    {/* <Star fill="yellow" /> */}
                    <Server width={50} height={50} className="font-bold md:w-16 md:h-16 lg:w-20 lg:h-20" />
                    <div className="absolute inset-0 bg-gradient-to-br from-green-400/20 to-transparent pointer-events-none border-2 border-green-500"></div>
                </div>
            ...
            {/* Cloud */}
            <div className="flex flex-col justify-center items-center gap-2">
                <div className="relative p-6 backdrop-blur-md bg-white/10 border border-white/20 shadow-lg hover:bg-white/20 hover:text-sky-200 transition-all duration-300 hover:scale-105"
                    onMouseEnter={() => setLineColor("bg-sky-200")}
                    onMouseLeave={() => setLineColor("bg-white/20")}
                >
                    <Cloud width={50} height={50} className="font-bold md:w-16 md:h-16 lg:w-20 lg:h-20" />
                    <div className="absolute inset-0 bg-gradient-to-br from-sky-200/20 to-transparent pointer-events-none border-2 border-sky-200"></div>
                </div>
            ...
            {/* Databases */}
            <div className="flex flex-col justify-center items-center gap-2">
                <div className="relative p-6 backdrop-blur-md bg-white/10 border border-white/20 shadow-lg hover:bg-white/20 hover:text-amber-400 transition-all duration-300 hover:scale-105"
                    onMouseEnter={() => setLineColor("bg-amber-400")}
                    onMouseLeave={() => setLineColor("bg-white/20")}
                >
                    <Database width={50} height={50} className="font-bold md:w-16 md:h-16 lg:w-20 lg:h-20" />
                    <div className="absolute inset-0 bg-gradient-to-br from-amber-400/20 to-transparent pointer-events-none border-2 border-yellow-500"></div>
                </div>
