...
const MobileSocialMedia = ({ title, imagePath, gradient = "purple", customColor, imageSize = 25, url }: MobileSocialMedia) => {
    ...
    return (
        <div className={`flex flex-col w-full px-10`}>
            <a
                ...
                target="_blank"
                className={`
                    relative flex justify-between items-center ${backgroundClass} h-12 px-4
            ...
            >
                ...
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-white font-medium">Access {title}</span>
                </div>
